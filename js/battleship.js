  ...
  fire: function (guess) {
    for (var i = 0; i < this.numShips; i++) {
      ...
      if (ship.hits[index] === "hit") {
        view.displayMessage("Oops, you already hit that location silly goose!");
        return true;
      } else if (index >= 0) {
        ship.hits[index] = "hit";
        ...
        if (this.isSunk(ship)) {
          view.displayMessage("You sank my battleship silly goose!");
          this.shipsSunk++;
        }
        return true;
      }
    ...
    view.displayMessage("You missed, you silly goose.");
    return false;
  },
...
var controller = {
  ...
  processGuess: function (guess) {
    ...
    var accuracy = Math.round((9 / this.guesses) * 100 - 1);
    if (location) {
      this.guesses++;
